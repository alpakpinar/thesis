...
Provided that the DM particle $\chi$ is light enough for the $\textrm{H} \rightarrow \chi \bar{\chi}$ decay to occur (\textit{i.e.,} $M_{\chi} < M_{\textrm{H}} / 2$), there will be a non-zero
