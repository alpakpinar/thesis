...
\beginchapterabstract{Experimental Apparatus}
\label{chap:apparatus}

This chapter provides a comprehensive exploration of the design 
and operational principles underlying the Large Hadron Collider (LHC) and the Compact Muon Solenoid (CMS) detector.
The chapter systematically breaks down the essential sub-components of the CMS detector. 
First, the tracker system is analyzed, highlighting its role in 
reconstructing the trajectories of charged particles 
with high precision. Next, the chapter details the electromagnetic 
and hadronic calorimeters, highlighting their role in 
measuring the energy of photons, electrons, and hadrons. 
The muon system is also thoroughly reviewed, 
emphasizing its importance in detecting muons, which are crucial for a variety of physics analyses.
The chapter ends with a brief discussion of the two-level triggering system, 
which is used to select proton-proton collision events of interest
