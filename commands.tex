\newcommand{\hinv}{\ensuremath{\textrm{H} \rightarrow \textrm{inv.}}\xspace}
\newcommand{\brhinv}{\ensuremath{{B(\textrm{H}\rightarrow\text{inv})}}\xspace}
\newcommand{\brinv}{\ensuremath{{{B}(\textrm{H}\rightarrow\text{inv})}}\xspace}
...
\newcommand{\Zeejets}{\ensuremath{\mathrm{Z}(\textrm{ee})+\textrm{jets}}}
...
\newcommand{\Wlvjets}{\ensuremath{\textrm{W}(\ell\nu)+\textrm{jets}}}
\newcommand{\Wmvjets}{\ensuremath{\textrm{W}(\mu\nu)+\textrm{jets}}}
\newcommand{\Wmnjets}{\ensuremath{\textrm{W}(\mu\nu)+\textrm{jets}}}
\newcommand{\Wevjets}{\ensuremath{\textrm{W}(\textrm{e}\nu)+\textrm{jets}}}
\newcommand{\Wenjets}{\ensuremath{\textrm{W}(\textrm{e}\nu)+\textrm{jets}}}
...
\newcommand{\ptmissnomu}{\ensuremath{p_{\textrm{T},\textrm{no}-\mu}^{\textrm{miss}}}\xspace}
\newcommand{\htmissnomu}{\ensuremath{H_{\textrm{T},\textrm{no}-\mu}^{\textrm{miss}}}\xspace}
...
\newcommand{\hfcss}{\ensuremath{\mathrm{CSS_{HF}}} }
...
\newcommand{\ptvecjet}{\ensuremath{{\vec p}_{\mathrm{T}}^{\;\text{jet}}}\xspace}
...
\newcommand{\pthiggs}{\ensuremath{p_{\mathrm{T}}^{\mathrm{H}}}}
...
\newcommand{\ptmisstrk}{\ensuremath{p_{\mathrm{T, trk}}^{\mathrm{miss}}}}
...
\newcommand{\ptvecmiss}{\ensuremath{\vec{p}_{\textrm{T}}^{\;\textrm{miss}}}\xspace}
\newcommand{\ptveci}{\ensuremath{\vec{p}_{T}^{\;i}}\xspace}

\newcommand{\detajj}{\Delta \eta_{\textrm{jj}}}
\newcommand{\dphijj}{\Delta \phi_{\textrm{jj}}}
\newcommand{\dphi}{\Delta \phi}
\newcommand{\mjj}{\ensuremath{M_{\textrm{jj}}}}

\newcommand{\muz}{\ensuremath{\boldsymbol{\mu}^{\Zvv}}}
\newcommand{\vbf}{\ensuremath{\mathrm{qqH}}}
\newcommand{\ggh}{\ensuremath{\mathrm{ggH}}}
\newcommand{\VBF}{\ensuremath{\mathrm{qqH}}}
\newcommand{\ggH}{\ensuremath{\mathrm{ggH}}}
\newcommand{\vh}{\ensuremath{\mathrm{VH}}}
\newcommand{\tth}{\ensuremath{\mathrm{ttH}}}

\newcommand{\sigmabr}{\ensuremath{(\sigma_{\mathrm{H}}/\sigma_{\mathrm{H}}^{\mathrm{SM}}) \brhinv}\xspace}
...
\newcommand{\mhiggs}{\ensuremath{m_{\textrm{H}}}}

\providecommand{\cmsTable}[1]{\resizebox{\textwidth}{!}{#1}}

% Redefine the chapter command to include an abstract
\newcommand{\beginchapterabstract}[1]{%
  \begingroup
  \let\cleardoublepage\relax
  \let\clearpage\relax
  \chapter{#1}
%   \vspace{-3em} % Adjust the space after chapter title
  \begin{center}
  \textbf{Abstract}
  \end{center}
  \begin{quote}
...
\newcommand{\finishchapterabstract}{%
  \end{quote}
  \endgroup
}